...
public class Page {
    ...
    public Page(int currentPage, int pageSize, Collection items) {
        this.currentPage = currentPage;
        this.pageSize = pageSize;
        this.items = items;
    }

    public Page(int currentPage, int pageSize, Collection items, int groupSize) {
        this.currentPage = currentPage;
        this.pageSize = pageSize;
        this.items = items;
    ...
    public static void main(String[] args) {
        ...
        Page page = new Page(1,10,items,10);
